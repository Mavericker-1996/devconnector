...
router.post(
  ...
  async (req, res) => {
    ...
    try {
      ...
      if (profile) {
        // Update profile and return the new profile
 ...
 * @access   Public
 * @see {@links https://developer.github.com/v3/#increasing-the-unauthenticated-rate-limit-for-oauth-applications}
 */
